...
- [`5.11.50`, `5.11` (*v5.11.50/5.11*)](https://github.com/ryansch/docker-unifi-rpi/blob/v5.11.50/5.11)
- [`5.12.66`, `5.12`, `5`, `latest` (*v5.12.66/5.12*)](https://github.com/ryansch/docker-unifi-rpi/blob/v5.12.66/5.12)
- [`5.13.18` (*5.13*)](https://github.com/ryansch/docker-unifi-rpi/blob/master/5.13)
